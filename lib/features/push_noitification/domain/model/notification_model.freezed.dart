...
/// @nodoc
@JsonSerializable()
@HiveType(typeId: HiveBox.notificationHiveId)
class _$NotificationModelImpl implements _NotificationModel {
  ...
  @override
  String toString() {
    return 'NotificationModel(id: $id, message: $message, createdAt: $createdAt)';
  }
...
abstract class $MessageCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@HiveField(0) Notification notification,
      @HiveField(1) String? senderId,
      @HiveField(2) String? receiverId,
      @HiveField(3) String? orderId});
...
class _$MessageImpl implements _Message {
  const _$MessageImpl(
      {@HiveField(0) required this.notification,
      @HiveField(1) required this.senderId,
      @HiveField(2) required this.receiverId,
      @HiveField(3) required this.orderId});
  ...
  @override
  String toString() {
    return 'Message(notification: $notification, senderId: $senderId, receiverId: $receiverId, orderId: $orderId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, notification, senderId, receiverId, orderId);
...
abstract class _Message implements Message {
  const factory _Message(
      {@HiveField(0) required final Notification notification,
      @HiveField(1) required final String? senderId,
      @HiveField(2) required final String? receiverId,
      @HiveField(3) required final String? orderId}) = _$MessageImpl;
...
abstract class _Notification implements Notification {
  const factory _Notification(
      ...
      @HiveField(1) required final String body}) = _$NotificationImpl;
